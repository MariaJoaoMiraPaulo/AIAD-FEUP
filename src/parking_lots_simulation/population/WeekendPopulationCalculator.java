...
public class WeekendPopulationCalculator extends PopulationCalculator {
	@Override
	public double calculate(double x) {
		return POPULATION_MODIFIER
				* (4.4650115275983417e+001 + -3.1345989640402735e+001 * x + 7.7796384043764249e+001 * Math.pow(x, 2)
