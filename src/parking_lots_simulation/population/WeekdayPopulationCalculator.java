...
public class WeekdayPopulationCalculator extends PopulationCalculator {
	@Override
	public double calculate(double x) {
		return POPULATION_MODIFIER
				* (7.4759504935373840e+001 + -4.3481968317186556e+001 * x + 1.1580478885389195e+002 * Math.pow(x, 2)
